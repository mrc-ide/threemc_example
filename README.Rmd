...
The memory is spiking during tape optimisation which means we need to run on a machine with > 500GB of memory. This amount of memory is only used for a small period of the model fit and the rest of the fit continues. We're trying to understand
